...
// Use session stored serial_no and entry_year (login မှာသိမ်းထားတယ် assumed)
$serial_no = $_SESSION['student_id'] ?? null;
$entry_year = $_SESSION['entry_year'] ?? null;

if (!$serial_no || !$entry_year) {
    // Not logged in or session expired
    header("Location: home.php");
    exit();
}

// Fetch student data from DB (based on session serial_no)
$stmt = $mysqli->prepare("SELECT * FROM students WHERE serial_no = ? AND entry_year = ?");
if (!$stmt) {
    die("Prepare failed: " . $mysqli->error);
}
$stmt->bind_param("ss", $serial_no, $entry_year);
$stmt->execute();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['submit_form'])) {
    ...
    // Collect and sanitize student data from POST
    $studentData = [
        'serial_no' => $serial_no, // Use session value, do not trust form input here for security
        ...
        'father_ethnicity' => filter_input(INPUT_POST, 'father_ethnicity', FILTER_SANITIZE_STRING),
        ...
        'father_address_home' => filter_input(INPUT_POST, 'father_address_home', FILTER_SANITIZE_STRING),
        ...
        'mother_ethnicity' => filter_input(INPUT_POST, 'mother_ethnicity', FILTER_SANITIZE_STRING),
        ...
        'current_house_no' => filter_input(INPUT_POST, 'current_house_no', FILTER_SANITIZE_STRING),
        ...
        'image_path' => $studentData['image_path'] ?? 'image/default.png'
    ];
    ...
    // Collect exam results from POST (only non-empty)
    $examResults = [];
    for ($i = 1; $i <= 5; $i++) {
...
<body>
    <div class="container form-container">
        <form id="studentForm" method="POST" enctype="multipart/form-data" action="payment.php">
            ...
            <div class="form-section active" id="page1">
                <table class="main-table">
                    ...
                    <label for="fileupload" class="d-block">
                        <div class="image-preview-container mb-2">
                            <?php if (!empty($studentData['image_path'])): ?>
                                <img id="preview" src="<?php echo htmlspecialchars($studentData['image_path']); ?>" class="image-preview" alt="Student Photo">
                            <?php else: ?>
                                <img id="preview" src="data:image/svg+xml;charset=UTF-8,..." class="image-preview" alt="Student Photo">
                            <?php endif; ?>
                        </div>
                    ...
                    <tr>
                        ...
                        <td style="display: flex; gap: 5px; align-items: center;">
                            ...
                            <input type="text" name="serial_no" id="serial_no" pattern="\d{5}" maxlength="5" placeholder="e.g., 24001" 
                                   ...
                                   class="form-control" onchange="fetchStudentData(this.value)" <?php echo isset($_GET['serial_no']) ? 'readonly' : ''; ?>>
                            <?php if(isset($_GET['serial_no'])): ?>
                            <button type="button" class="btn btn-sm btn-warning edit-serial-btn" onclick="enableSerialEdit()">
                ...
                <table class="main-table">
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="student_name_mm" value="<?php echo isset($studentData['student_name_mm']) ? $studentData['student_name_mm'] : ''; ?>" placeholder="မောင်ကျော်ကျော် / မလှလှ" class="form-control" required></td>
                        <td><input type="text" name="father_name_mm" value="<?php echo isset($studentData['father_name_mm']) ? $studentData['father_name_mm'] : ''; ?>" placeholder="ဦးမောင်မောင်" class="form-control" required></td>
                        <td><input type="text" name="mother_name_mm" value="<?php echo isset($studentData['mother_name_mm']) ? $studentData['mother_name_mm'] : ''; ?>" placeholder="ဒေါ်အေးအေး" class="form-control" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="father_nationality" value="<?php echo isset($studentData['father_nationality']) ? $studentData['father_nationality'] : ''; ?>" class="form-control" required></td>
                        <td><input type="text" name="mother_nationality" value="<?php echo isset($studentData['mother_nationality']) ? $studentData['mother_nationality'] : ''; ?>" class="form-control" required></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="father_region" value="<?php echo isset($studentData['father_address_region']) ? $studentData['father_address_region'] : ''; ?>" class="form-control mt-1" placeholder="ပြည်နယ်/တိုင်း" required>
                        </td>
                        <td>
                            ...
                            <input type="text" name="mother_region" value="<?php echo isset($studentData['mother_address_region']) ? $studentData['mother_address_region'] : ''; ?>" class="form-control mt-1" placeholder="ပြည်နယ်/တိုင်း" required>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-2">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" name="home_no" value="<?php echo isset($studentData['current_home_no']) ? $studentData['current_home_no'] : ''; ?>" class="form-control">
                                    </div>
                                    <div class="col-md-6">
                                        <label>လမ်းအမှတ်</label>
                                        <input type="text" name="street_no" value="<?php echo isset($studentData['current_street']) ? $studentData['current_street'] : ''; ?>" class="form-control">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-md-6">
