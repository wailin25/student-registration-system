...
<head>
    <meta charset="UTF-8">
    <title>Resend Verification - UCS Magway</title>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="verification-info">
                <h5><i class="fas fa-info-circle me-2"></i> Verification Required</h5>
                <p>If you didn't receive your verification email, please enter your email address below. We'll send you a new verification link to activate your account.</p>
            </div>
            ...
            <form action="resend-code.php" method="POST">
                ...
                <button type="submit" name="resend_email_verify_btn" class="btn btn-primary">
        ...
        <div class="card-footer">
            <p>Remember your password? <a href="login.php">Login to your account</a></p>
        </div>
    </div>
</div>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        const formElements = document.querySelectorAll('.form-group, .btn-primary, .verification-info');
